...
@RestController @RequestMapping("/api/orders") public class OrderController {
 ...
 @PostMapping("/checkout") public Order checkout(@RequestParam String shippingAddress,@RequestParam(defaultValue="PAY_ON_DELIVERY") String paymentMethod, Principal p){return service.checkout(p.getName(),shippingAddress,paymentMethod);}
