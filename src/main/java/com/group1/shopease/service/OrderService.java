...
@Service public class OrderService {
    ...
    @Transactional public Order checkout(String email,String address){
        ...
        var total=items.stream().map(com.group1.shopease.model.CartItem::lineTotal).reduce(java.math.BigDecimal.ZERO,java.math.BigDecimal::add); Order order=orders.create(buyer,total,address);
